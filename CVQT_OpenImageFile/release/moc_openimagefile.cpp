...
QT_MOC_LITERAL(5, 85, 23) // "on_actionExit_triggered"
...
void OpenImageFile::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        OpenImageFile *_t = static_cast<OpenImageFile *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject OpenImageFile::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_OpenImageFile.data,
      qt_meta_data_OpenImageFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OpenImageFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpenImageFile.stringdata0))
        return static_cast<void*>(const_cast< OpenImageFile*>(this));
